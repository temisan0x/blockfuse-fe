...
export default function Features({ title, imageUrl, description="" }) {
  return (
    <section className="py-16 px-6 sm:px-10 lg:px-20 text-white overflow-hidden">
      <div className="max-w-7xl mx-auto relative overflow-hidden">
        <img
          className="absolute w-1/6 h-64 object-cover opacity-50 z-[-1]"
        ...
        <p className="mx-auto text-center mt-10 text-[18px]">
       {description}
        </p>
      </div>
    </section>
