    ...
    return (
        <section className="py-16 px-6 sm:px-10 lg:px-20 text-white overflow-hidden">
            <div className="max-w-7xl mx-auto relative overflow-hidden">
                {/* Decorative Gradient (Static on the Left) */}
                <img
                ...
                {/* Content Container (Shifted to the Right) */}
                <div className="relative z-10">
                    {/* Main Text (Shifted to the Right) */}
                    ...
                    {/* Main Image with Larger Size (Shifted to the Right) */}
