        ...
        <section className="py-16 px-6 sm:px-10 lg:px-20  text-white">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold mb-16 mt-40 sm:mt-32 md:mt-40 text-center text-white">
                ...
                <div className="space-y-4">
                    {faqs.map((faq, index) => (
                        <div key={index} className=" border border-purple-500 border-r-transparent border-l-transparent border-t-transparent">
                            <button
                                className="w-full py-6 text-left flex justify-between items-center  transition-colors duration-300"
                            >
